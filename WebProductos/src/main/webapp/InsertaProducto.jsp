...
<table style="width: 400px;">
 ...
 <tbody>
  ...
  <tr>
   ...
   <td><input maxlength="11" size="24" type="text" name="secc"/></td>
  </tr>
 
  <tr>
   <td>NOMBREART&Iacute;CULO</td>
   <td><input maxlength="24" size="24" type="text" name="nomb"/></td>
  </tr>
 
  <tr>
   <td>PRECIO</td>
   <td><input maxlength="10" size="24" type="text" name="prec"/></td>
  </tr>
 
  <tr>
   <td>FECHA</td>
   <td><input maxlength="10" size="24" type="text" name="fec"/></td>
  </tr>
 
  <tr>
   <td>IMPORTADO</td>
   <td><input maxlength="9" size="24" type="text" name="impo"/></td>
  </tr>
 
  <tr>
   <td>PA&Iacute;SDEORIGEN</td>
   <td><input maxlength="9" size="24" type="text" name="paor"/></td>
  </tr>
